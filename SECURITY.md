...
DebugDoc has not published a stable release yet. Security fixes will be applied to the latest development branch until a version support policy is announced.
...
- Affected operating systems and DebugDoc version/commit
